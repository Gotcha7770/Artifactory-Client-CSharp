namespace ArtifactoryClient.Interfaces
{
    ...
    {
        ISearchConfiguration ArtifactsByName(string name);

        ISearchConfiguration ArtifactsCreatedSince(long sinceMillis); //Date???

        ISearchConfiguration ArtifactsCreatedInDateRange(long fromMillis, long toMillis);
         ...
         * @return this object
         */
        ISearchConfiguration ArtifactsByGavc();
         ...
         * @return this object
         */
        ISearchConfiguration ArtifactsLatestVersion();
    }
}
